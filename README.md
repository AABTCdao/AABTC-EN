...
4. Information Revolution and Digital Economy
...
In order to transmit value, human beings start from money, and will also create a value transmission network that matches the Internet.
...
2. Cisco router technology, which was born in 1984: It is an imitation of blockchain technology
...
3. The B/S (C/S) architecture that came with the birth of the World Wide Web: the opponent of the blockchain and the object of its attempt
...
4. Peer-to-peer network (P2P): the father and technology foundation of blockchain
...
5. Hashing algorithm: the key to generating bitcoins and tokens (tokens).
...
3. Blockchain is a peer-to-peer network (P2P) software application that uses a hash algorithm to generate "tokens" for network-wide information synchronization
...
Let's say, Bitcoin could do it all over again!
